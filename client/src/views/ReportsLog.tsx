...
export default function ReportsLog() {
  ...
  if (isLoading) {
    return <div className="p-8 text-center animate-pulse">Loading reports database...</div>;
  }
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 no-print">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 rounded-xl shadow-sm p-6 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="relative">
          <label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase tracking-wider">Search Keyword</label>
          <div className="relative">
            <input
              type="text"
              ...
              className="w-full pl-9 pr-3.5 py-1.5 rounded-lg bg-slate-50 dark:bg-slate-955 border border-slate-200 dark:border-slate-800 text-xs text-slate-800 focus:outline-none"
            />
